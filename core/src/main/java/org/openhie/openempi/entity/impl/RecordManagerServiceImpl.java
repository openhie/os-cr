	...
	public Record addRecord(Entity entity, Record record) throws ApplicationException {
		...
		try {
		    if (entity.getSynchronousMatching()) {
                ...
                RecordState state = new RecordState(record.getRecordId(), IdentifierUpdateEvent.ADD_SOURCE); // getRecordId returns Long, RecordState expects long, NPE can be caused by getRecordId returning null
