 ...
 */
public class MatchFieldImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openhie.openempi.configuration.xml.shallowmatching.MatchField
{
    ...
    private static final javax.xml.namespace.QName FIELDNAME$0 = 
        new javax.xml.namespace.QName("http://configuration.openempi.openhie.org/shallow-matching", "field-name");
    private static final javax.xml.namespace.QName COMPARATORFUNCTION$2 = 
        new javax.xml.namespace.QName("http://configuration.openempi.openhie.org/shallow-matching", "comparator-function");
    private static final javax.xml.namespace.QName MATCHTHRESHOLD$4 = 
        new javax.xml.namespace.QName("http://configuration.openempi.openhie.org/shallow-matching", "match-threshold");
    ...
    public org.openhie.openempi.configuration.xml.ComparatorFunction addNewComparatorFunction()
    {
        ...
        {
            check_orphaned();
            org.openhie.openempi.configuration.xml.ComparatorFunction target;
            target = (org.openhie.openempi.configuration.xml.ComparatorFunction)get_store().add_element_user(COMPARATORFUNCTION$2);
            return target;
        }
    }
