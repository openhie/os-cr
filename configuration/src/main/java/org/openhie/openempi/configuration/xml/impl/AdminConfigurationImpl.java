...
public class AdminConfigurationImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openhie.openempi.configuration.xml.AdminConfiguration
{
    ...
    private static final javax.xml.namespace.QName DATADIRECTORY$4 = 
        new javax.xml.namespace.QName("http://configuration.openempi.openhie.org/mpiconfig", "data-directory");
    ...
    public java.lang.String getDataDirectory()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(DATADIRECTORY$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public org.apache.xmlbeans.XmlString xgetDataDirectory()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_element_user(DATADIRECTORY$4, 0);
            return target;
        }
    }
    ...
    public void setDataDirectory(java.lang.String dataDirectory)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(DATADIRECTORY$4);
            }
            target.setStringValue(dataDirectory);
        }
    }
     ...
     */
    public void xsetDataDirectory(org.apache.xmlbeans.XmlString dataDirectory)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_element_user(DATADIRECTORY$4);
            }
            target.set(dataDirectory);
        }
    }
    ...
    public org.openhie.openempi.configuration.xml.UpdateNotificationEntries addNewUpdateNotificationEntries()
    {
        ...
        {
            check_orphaned();
            org.openhie.openempi.configuration.xml.UpdateNotificationEntries target;
            target = (org.openhie.openempi.configuration.xml.UpdateNotificationEntries)get_store().add_element_user(UPDATENOTIFICATIONENTRIES$6);
            return target;
        }
    }
